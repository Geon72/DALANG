        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
          <div class="p-6 sm:p-8">
            ...
            <ol class="flex items-center justify-center mb-8">
              <li v-for="(step, index) in steps" :key="index" class="flex items-center" :class="{ 'text-blue-600 font-semibold': currentStep === index + 1, 'text-gray-400': currentStep !== index + 1 }">
                <span class="w-8 h-8 flex items-center justify-center border-2 rounded-full mr-2" :class="{ 'border-blue-600 bg-blue-600 text-white': currentStep === index + 1, 'border-gray-300': currentStep !== index + 1 }">
                  {{ index + 1 }}
                </span>
                {{ step }}
            ...
            <div v-else-if="currentStep === 2" key="additional-info">
              ...
              <form @submit.prevent="register" class="space-y-6">
                ...
                <div class="flex justify-between">
                  <button @click="previousStep" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Back
                  </button>
