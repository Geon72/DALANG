<template>
    <div class="min-h-screen bg-gray-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        <div>
          <img class="mx-auto h-12 w-auto" src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DALANG_FINAL-zgVATAcLguH8yROQhqFJRCjh3gdKx4.png" alt="DALANG Logo">
        ...
        <div class="mt-6">
          ...
          <div class="mt-6 grid grid-cols-2 gap-3">
            <div>
              <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-[#FEE500] text-sm font-medium text-[#000000] hover:bg-[#FEE500]/90 transition duration-150 ease-in-out">
                Kakao
              </a>
            </div>
            <div>
